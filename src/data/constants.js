export const Bio = {
  ...
  description:
    "I'm Nikhil S Patil, a Computer Engineering student passionate about coding and solving real-world problems. With hands-on experience in HTML, CSS, JavaScript, Java, and Spring Boot, I aim to build secure and scalable solutions. My certifications in Google Cloud and AWS Machine Learning also show my commitment to expanding my expertise in cloud and AI domains.",
  github: "https://github.com/nikhilpatil009",
  resume: "https://drive.google.com/file/d/1kGTBm2uewuS4XeuGZzndw6rXZRywCKLu/view?usp=drivesdk",
  linkedin: "https://www.linkedin.com/in/nikhil-patil-051663281",
  twitter: "",
  insta: "",
  facebook: "",
};
    ...
    skills: [
      {
        ...
        image:
          "https://i.pinimg.com/474x/32/1f/d6/321fd6682e66686eb0fdca182a4a3f22.jpg",
      },
      {
        name: "Python",
        image:
...
export const experiences = [
  {
    id: 0,
    img: "https://upload.wikimedia.org/wikipedia/commons/thumb/1/14/Xceedance_Logo.svg/2560px-Xceedance_Logo.svg.png",
    role: "Associate Programmer Intern",
    company: "Xceedance Pvt. Ltd.",
    date: "January 2025 - Present",
    desc: "Contributing to full-stack development using Spring Boot and Angular as part of enterprise applications. Worked on internal projects like a Music Library System and played a key role in building the company’s capstone project — 'Renter Insurance Broker Portal' — focusing on backend architecture, API integrations, and clean UI design.",
    skills: [
      "Spring Boot",
      "Angular",
      "Duck Creek",
...
export const projects = [
  ...
  {
    id: 9,
    title: "Document Upload and Verification using Blockchain",
    date: "Jan 2024 - Apr 2024",
    description:
      "Designed and developed a secure e-certificate generation system using smart contracts in a blockchain environment. This project ensured document authenticity and tamper-proof verification.",
    image:
  ...
  },
  {
    ...
    description:
      "A web-based insurance broker portal built using Angular and Spring Boot, featuring authentication, quote management, and a user dashboard. It enables insurance brokers to efficiently manage clients and policies.",
    image:
      "https://user-images.githubusercontent.com/64485885/234602896-a1bd8bcc-b72b-4821-83d6-8ad885bf435e.png",
    tags: ["MySQL", "HTML", "CSS", "PHP", "JavaScript" ],
    category: "web app",
    github: "",
    webapp: "",
